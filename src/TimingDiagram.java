        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addComponent(jSlider1, javax.swing.GroupLayout.PREFERRED_SIZE, 1000,
...
class TimingPaint extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < code.length(); i++, addressDec++) {
            cycleDecoder(code.charAt(i), o.engine.Dec2Hex(addressDec),
                    o.engine.Dec2Hex2digit(o.matrix.memory[addressDec]));
        }
    }
